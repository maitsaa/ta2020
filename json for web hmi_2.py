...
def main():
    ...
    while True:
        ...
        if jsondata !='':
            ...
            print ("{TX = ",TX, "}", "{RSSI = ",RSSI, "}","{Temperature = ",temperature, "}", "{Humidity = ",humidity, "}", "{co = ",co, "}", "{co2 = ",co2, "}")
            print ("{TX = ",TX_2, "}", "{RSSI = ",RSSI_2, "}","{Temperature = ",temperature_2, "}", "{Humidity = ",humidity_2, "}", "{co = ",co_2, "}", "{co2 = ",co2_2, "}")
            print ("{TX = ",TX_3, "}", "{RSSI = ",RSSI_3, "}","{Temperature = ",temperature_3, "}", "{Humidity = ",humidity_3, "}", "{co = ",co_3, "}", "{co2 = ",co2_3, "}")
            print ("{TX = ",TX_4, "}", "{RSSI = ",RSSI_4, "}","{Temperature = ",temperature_4, "}", "{Humidity = ",humidity_4, "}", "{co = ",co_4, "}", "{co2 = ",co2_4, "}")
